...
const WashingMachineCovers = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get("http://localhost:5000/api/products/search/category/WashingMachineCovers");
      ...
      <div className="textile-wrapper">
        <div className="textile-header">
          <div className="textile-info">
            <h2>Washing Machine Covers</h2>
            <p className="breadcrumb">Home / Shop / <span>Washing Machine Covers</span></p>
          </div>
...
export default WashingMachineCovers;
