...
const MatressCover = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get("http://localhost:5000/api/products/search/category/MatressCover");
      ...
      <div className="textile-wrapper">
        <div className="textile-header">
          <div className="textile-info">
            <h2>Matress Cover</h2>
            <p className="breadcrumb">Home / Shop / <span>Matress Cover</span></p>
          </div>
