...
const Organza = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get("http://localhost:5000/api/products/search/category/Organza");
    ...
    <div className="summer-page">
      <div className="summer-header">
        <div className="summer-title">
          ...
          <p className="summer-breadcrumb">Home / Shop / Clothing / <span>Organza</span></p>
        </div>
